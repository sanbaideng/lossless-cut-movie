...

    {
      ...
      submenu: [
        ...
        },
        {
          ...
          async click() {
            const { canceled, filePaths } = await dialog.showOpenDialog({
              properties: ["openFile1", "multiSelections"],
            });
            if (canceled) return;
            mainWindow.webContents.send("file-opened1", filePaths);
          },
        },
        {
          label: "Close",
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          label: "Learn More",
          click() {
            electron.shell.openExternal(homepage);
          },
        },
        {
          label: "Report an error",
          click() {
            mainWindow.webContents.send("openSendReportDialog");
          },
        },
      ],
    },
      ...
      submenu: [
        {
          ...
          click() {
            electron.shell.openExternal(releasesPage);
          },
        },
      ],
    });
